    ...
    return(
        ...
        {/* <Header/> */}
            ...
            <img src={About1} alt="" className="w-full h-auto "/>
             ...
             <div className=" text-sm sm:text-xl mx-20 para">
             <p className="mb-6">
             ...
             <p className=" text-sm sm:text-xl   para mb-6 mx-20">
            ...
            <p className="text-sm sm:text-xl  para mb-10 mx-20">
            ...
            <div className="text-sm sm:text-xl para mx-20 mb-8 font-bold">
