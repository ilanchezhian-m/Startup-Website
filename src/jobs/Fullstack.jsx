...
export function Fullstack(){
    return(
        ...
        <h1 className="text-center text-2xl p-10 ">Full Stack Developer role</h1>
        <div className="job-styl text-left ml-20 text-xl leading-10">
            <p>COMPANY: <span className="font-bold">TAS INNOVATION</span> </p>
            <p>JOB TITLE: <span className="font-bold">FULL STACK DEVELOPER</span> </p>
            ...
            <p>SALARY: <span className="font-bold">3-6 LPA</span> </p>   
        </div>
